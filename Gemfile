...
gem "rails", "~> 8.1.3"
# ActiveSupport 8.1.3.1 passes JSON.parse options positionally; json 3 accepts
# keyword options only. Keep the compatible API until Rails updates its decoder.
gem "json", "< 3"
