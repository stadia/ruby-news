...
class ActiveStorage::Service::DiskService < ::ActiveStorage::Service
  ...
  def public_url(key, filename:, content_type: T.unsafe(nil), disposition: T.unsafe(nil), **); end
...
class ActiveStorage::Service::S3Service < ::ActiveStorage::Service
  ...
  def headers_for_direct_upload(key, content_type:, checksum:, filename: T.unsafe(nil), disposition: T.unsafe(nil), custom_metadata: T.unsafe(nil), **); end
  ...
  def upload(key, io, checksum: T.unsafe(nil), filename: T.unsafe(nil), content_type: T.unsafe(nil), disposition: T.unsafe(nil), custom_metadata: T.unsafe(nil), **); end
